...
<div style="text-align: center; position: relative; margin-left: 30px; margin-right: 30px;">
    <div style="position: relative; height: 500px; width: 100%; overflow: hidden;">
        ...
        <div style="position: absolute; top: 50%; left: 20%; transform: translate(-50%, -50%); color: white; text-align: center; z-index: 2;">
    ...
    <div style="position: relative; width: 100%; height: 500px; background-color: black; margin-top: 30px;">

        <h3 style="color: white; font-size: 3.5em; font-weight: bold; position: absolute; top: 20px; left: 500px;">Por qué elegirnos</h3>

        <img src="/images/cuerdas.png" style="height: auto; width: auto; max-width: 340px; position: absolute; left: 50px; top: 100px;">
        <div style="position: absolute; left: 30px; top: 350px; color: white; text-align: center;">
            <p style="font-size: 1.5em; font-weight: bold;">Contamos con actividades para<br> satisfacer a todos los entusiastas del <br> fitness. Si existe, aqui podrás realizarlo.</p>
        </div>

        <img src="/images/vacia.png" style="height: auto; width: auto; max-width: 340px; position: absolute; left: 520px; top: 100px;">
        <div style="position: absolute; left: 500px; top: 350px; color: white; text-align: center;">
            <p style="font-size: 1.5em; font-weight: bold;">Garantizamos la máxima calidad tanto<br> en nuestras instalaciones como en <br> nuestros servicios.</p>
        </div>

        <img src="/images/choque.png" style="height: auto; width: auto; max-width: 340px; position: absolute; left: 1000px; top: 100px;">
        <div style="position: absolute; left: 920px; top: 350px; color: white; text-align: center;">
