...
<head>
    ...
    <title>{{ config('app.name', 'GymPulse') }}</title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                ...
                <img src="{{ asset('images/logo/logo.png') }}" alt="GymPulse Logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @if(request()->is('/'))
                            @auth
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="http://localhost:8080/tiendaropa/catalogo" target="_blank">{{ __('Material') }}</a>
                                </li>
            ...
            <div class="container-fluid mt-5 pt-5 text-center text-md-start">
                <div class="row text-center text-md-start text-start">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                        ...
                        <hr class="bg-light border-2 border-top border-light mb-4">
                        <p>
                            <img src="https://cdn-icons-png.flaticon.com/128/2500/2500456.png" alt="" width="25" height="25" class="d-inline-block align-text-center" />
                            Alicante, España 03690
                        </p>
                        <p>
                            <img src="https://cdn-icons-png.flaticon.com/128/747/747483.png" alt="" width="25" height="25" class="d-inline-block align-text-center" />
                            gympulse@gmail.com
                        </p>
                        <p>
                            <img src="https://cdn-icons-png.flaticon.com/128/747/747593.png" alt="" width="25" height="25" class="d-inline-block align-text-center" />
                            699 18 26 70
                        </p>
                    </div>
                                ...
                                <div class="text-center">
                                    <ul class="list-unstyled list-inline">
                                        <li class="list-inline-item">
                                            <a href="https://es-es.facebook.com/" class="text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                                                </svg></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="https://www.instagram.com/" class="text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="https://twitter.com/home?lang=es" class="text-light">
                                    ...
                                    <p class="text-muted">© 2023 Universidad de Alicante</p>
                                </div>
                            </div>
                        </div>
                    </div>
